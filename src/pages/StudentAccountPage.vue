<template>
  <div class="account-page">
    <nav>
      ...
      <div class="nav-badge">Student Portal &nbsp;|&nbsp; v1.0</div>
      ...
      <div class="account-grid">
        ...
        <div class="quick-actions">
          ...
          <div class="action-buttons">
            <RouterLink to="/student-information" class="action-btn">
              <span>View Records</span>
            </RouterLink>
            <RouterLink to="/scheduling" class="action-btn">
              <span>Class Schedule</span>
            </RouterLink>
            <RouterLink to="/events" class="action-btn">
...
onMounted(() => {
  if (!user.value || user.value.role !== 'student') {
    // router.push('/login'); // We let router guard handle this generally
  }
});
</script>
